...
// import img
import Image from '../assets/img/Arash.jpg';
    ...
    <section className='section bg-secondary' id='about'>
      <div className='container mx-auto'>
        <div className='flex flex-col md:flex-row xl:flex-row gap-24'>
          <img
            className='object-cover h-full w-[366px]  md:mx-0 lg:mx-0 rounded-2xl'
            src={Image}
            alt=''
          />
          <div className='flex flex-col items-center text-center md:items-start md:text-left lg:items-start lg:text-left'>
            <div className='flex flex-col'>
              <h2 className='text-3xl  lg:text-4xl font-medium lg:font-extrabold mb-3 before:content-about relative before:absolute before:opacity-40 before:-top-[2rem] before:hidden before:md:block before:lg:block'>
                Arash Haqdost
              </h2>
